...
> 开发 Agent 接手项目前，请先阅读 [AGENT_PROJECT_GUIDE.md](./AGENT_PROJECT_GUIDE.md)。该文档记录当前架构、真实功能状态、数据流、API、持久化方式、已知缺口与验证清单。
...
- 产品细节图：补充面料、缝线与局部工艺
- 人物图：控制人物身份与外观一致性
- 风格图：可影响视觉风格、姿势、动作、裁切、机位、背景、道具、物体位置与构图，但禁止复制主体、人物身份、脸、身体和服装设计
